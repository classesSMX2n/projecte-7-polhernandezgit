...
- Banner de Cookies: que informa al visitant de l’existència de cookies i li demana el seu consentiment.
- Consentiment en el formulari: El formulari de contacte ha de recollir nom, correu electrònic, telèfon i missatge.
- Checkbox de Dades: Heu d'afegir una casella de selecció (checkbox) obligatòria i desmarcada per defecte per demanar el consentiment exprés de les dades, la qual ha d'enllaçar a la política de privacitat.
- Checkbox de Comunicacions: Heu d'afegir una segona casella de selecció, desmarcada per defecte, per autoritzar l'enviament de comunicacions comercials, que enllaci a l'avís legal.

És important que totes les modificacions i noves pàgines mantinguin el disseny i estil original de la web corporativa.

## Enllaç del repositori
https://github.com/polhernandezgit/web-corporativa-Pol-H/tree/main

## Enllaç de la web
https://polhernandezgit.github.io/web-corporativa-Pol-H/
